window.wailsbindings='{"StartWindows":{"Api":{"DeviceRequest":{"name":"StartWindows.Api.DeviceRequest","inputs":[{"type":"string"},{"type":"string"},{"type":"string"},{"type":"interface {}"}],"outputs":[{"type":"map[string]interface {}"}]},"DeviceUpload":{"name":"StartWindows.Api.DeviceUpload","inputs":[{"type":"string"},{"type":"string"},{"type":"string"},{"type":"string"}],"outputs":[{"type":"map[string]interface {}"}]},"DownloadFile":{"name":"StartWindows.Api.DownloadFile","inputs":[{"type":"string"},{"type":"string"}],"outputs":[{"type":"bool"}]},"GetPlatform":{"name":"StartWindows.Api.GetPlatform","outputs":[{"type":"string"}]},"GetVersion":{"name":"StartWindows.Api.GetVersion","outputs":[{"type":"[]string"}]},"OpenFile":{"name":"StartWindows.Api.OpenFile","inputs":[{"type":"string"},{"type":"string"},{"type":"string"}],"outputs":[{"type":"string"}]},"SaveFile":{"name":"StartWindows.Api.SaveFile","inputs":[{"type":"string"},{"type":"string"}],"outputs":[{"type":"string"}]},"ServiceRequest":{"name":"StartWindows.Api.ServiceRequest","inputs":[{"type":"string"},{"type":"string"},{"type":"interface {}"},{"type":"string"}],"outputs":[{"type":"StartWindows.ReturnResponse"}]}}}}';
(() => {
